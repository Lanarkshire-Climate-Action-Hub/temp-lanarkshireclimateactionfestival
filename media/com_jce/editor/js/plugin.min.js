...
!function() {
    ...
    }(jQuery), window.tinyMCEPopup && (tinymce$1 = tinyMCEPopup.getWin().tinymce, 
    each = tinymce$1.each, PreviewCss = tinymce$1.util.PreviewCss, window.TinyMCE_Utils = {
        options: [],
        classes: [],
    ...
    var each, PreviewCss, ColorPicker, tinymce$1 = WFExtensions.add("Aggregator", {
        aggregators: {},
        add: function(name, o) {
    ...
    }), tinymce$1 = (window.WFAggregator = tinymce$1, WFExtensions.add("Popups", {
        popups: {},
        popup: "",
        config: {},
