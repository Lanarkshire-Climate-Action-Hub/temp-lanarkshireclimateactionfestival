...
$classes = ['uk-background-primary', 'uk-background-secondary', 'uk-background-orange', 'uk-background-yellow'];
...
?>
<h2 class="uk-padding sixty signpost_border <?php echo $backgroundClass; ?> bounce-on-hover uk-flex uk-flex-middle uk-text-center">
