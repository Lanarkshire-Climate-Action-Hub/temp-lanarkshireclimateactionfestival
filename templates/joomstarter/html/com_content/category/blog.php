...
<div class="com-content-category-blog blog" id="news">
    ...
    <div class="item-page<?php echo $this->pageclass_sfx; ?> uk-background-default uk-background-contain uk-height-medium uk-panel uk-flex uk-flex-middle" uk-grid style="background-image: url(images/dark.jpg);">
        <div class="uk-width-1-3@m uk-margin-large-left uk-margin-large-right">
