...
<div id="funding-page">
    ...
    <div id="faqs" class="uk-background-default">
        <div class="uk-container-expand uk-margin-large-left uk-margin-large-right">
            <div uk-grid>
            </div>
        </div>
    ...
    <div id="ready-to-apply">
        <div class="uk-container-expand">
            ...
            <div uk-grid class="uk-background-primary uk-padding-large uk-margin-remove">
                <div class="uk-width-2-3@m uk-width-1-1">
                    <?php echo $applyCopy; ?>
                </div>
                <div class="uk-position-relative">
                    <div class="uk-position-absolute fixing_bike_image">
                        <img src="/images/assets/fixing_bike.png" />
                    </div>
                </div>
    ...
    <div id="help-us" class="uk-background-secondary">
        <div class="uk-container-expand uk-margin-large-left uk-margin-large-right">
            <div uk-grid>
            </div>
        </div>
