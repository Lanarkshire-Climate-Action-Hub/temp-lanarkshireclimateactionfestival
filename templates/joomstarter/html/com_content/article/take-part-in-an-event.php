...
<div id="take-part-in-an-event">
    ...
    <div id="tips" class="uk-background-default uk-padding-large uk-padding-remove-left uk-padding-remove-right">
        <div class="uk-container-expand uk-margin-large-left uk-margin-xlarge-right mobile-text-full-width">
            ...
            <div uk-grid>
                <div>
                    <h2 class="uk-text-white gardein sixty_five uk-margin-bottom mobile-tips-background"><span class="uk-padding-small uk-background-secondary submit-button-border"><?php echo $tipsForEnjoyingTheFestivalSustainably_title; ?></span></h2>
