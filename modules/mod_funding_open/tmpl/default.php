...
<div class="mod_funding_open">
    <div class="uk-child-width-1-2@s uk-child-width-1-1@m" uk-grid>
        <div id="background" class="uk-background-contain uk-background-bottom-right uk-background-image@m <?php echo $background_color; ?> uk-height-medium uk-panel uk-flex uk-flex-middle" style="background-image: url(<?php echo htmlspecialchars($imagePath, ENT_QUOTES, 'UTF-8'); ?>); height: 90vh">
